...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->addAddress('info@messefrankfurtindia.in', 'Info Messe Frankfurt India');
        $mail->addCC('parna.das@india.messefrankfurt.com', 'Parna Das');
        $mail->addCC('anchal.choudhary@india.messefrankfurt.com', 'Anchal Choudhary');

        $mail->isHTML(true);
        $mail->Subject = 'India Refining Summit Partnership 2026';
